    ...
    <div className="min-h-[100dvh] bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 flex items-center justify-center px-6">
      ...
      <form className="liquid-glass w-full max-w-md rounded-3xl p-8 border border-black/10 dark:border-white/10 flex flex-col gap-5" onSubmit={handleSubmit}>
        <div className="space-y-2">
          <p className="text-[11px] font-mono uppercase tracking-[0.25em] text-zinc-500">Internal Access</p>
          <h1 className="text-3xl font-bold tracking-tight">Spec Sheets login</h1>
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            Minimal internal auth is enabled. The seeded bootstrap account is <span className="font-mono">sysadmin</span> with password{" "}
